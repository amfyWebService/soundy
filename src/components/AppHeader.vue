<template>
  <div>
    <v-app-bar color="#191919" dark app>
      <v-toolbar-title>
        <v-btn to="/" text large rounded>Soundy</v-btn>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <div class="text-center" v-else>
        <span class="mr-3">Hello {{user.firstname}}</span>
        <v-btn to="/login" class="ma-2" rounded color="purple">Logout</v-btn>
      </div>
    </v-app-bar>
  </div>
</template>
